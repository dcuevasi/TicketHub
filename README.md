...
- `status` (string, optional) - Filtrar por estado: `open`, `in_progress`, `closed`
  ...
  "items": [
    {
      "id": 1,
      "title": "Bug en login",
      "description": "El botón no responde",
      "status": "open",
      "priority": "high",
...
**Response:** Ticket creado (status 201)

#### **GET** `/tickets/{id}`
Obtener ticket por ID

**Response:** Objeto ticket
